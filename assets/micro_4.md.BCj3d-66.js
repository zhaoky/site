import{_ as a,c as s,o as p,R as e}from"./chunks/framework.4AYGp9T7.js";const u=JSON.parse('{"title":"Wujie 主流程源码阅读记录","description":"","frontmatter":{},"headers":[],"relativePath":"micro/4.md","filePath":"micro/4.md"}'),t={name:"micro/4.md"};function l(i,n,o,r,c,d){return p(),s("div",null,n[0]||(n[0]=[e(`<h1 id="wujie-主流程源码阅读记录" tabindex="-1">Wujie 主流程源码阅读记录 <a class="header-anchor" href="#wujie-主流程源码阅读记录" aria-label="Permalink to &quot;Wujie 主流程源码阅读记录&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>1. 主应用 index.js 执行 npm 包 wujie-react，内部执行 npm 包 wujie：</span></span>
...
<span class="line"><span>   —————————</span></span></code></pre></div>`,2)]))}const h=a(t,[["render",l]]);export{u as __pageData,h as default};
